...
This has been done for homogeneous space (see \citep{barton-depaulis-etheridge}),
...
we expect to be able to at least estimate \textit{relative} population density across space.
