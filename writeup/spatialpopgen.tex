...
%        \includegraphics[width=\linewidth]{figs/pedigree.pdf}
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
%        \includegraphics[width=\linewidth]{figs/spatial_pedigree.pdf}
        \caption{heterozygosity}
        \label{het}
    \end{subfigure}
        \caption{
		the effect of population density on tmrcas 
		and heterozygosity.
        }
        \label{pop_density}
\end{figure}
...
%        \includegraphics[width=\linewidth]{figs/pedigree.pdf}
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
%        \includegraphics[width=\linewidth]{figs/spatial_pedigree.pdf}
        \caption{map of relatedness}
        \label{cousin_map}
    \end{subfigure}
        \caption{
		a) isolation by distance in continuous space
		b) map for focal individual with points colored/sized according to closest degree of relatedness
...
%        \includegraphics[width=\linewidth]{figs/spatial_pedigree.pdf}
    ...
    \end{subfigure}
        \caption{
		a) adjacent valleys with lower pop density along the intervening ridge,
			with arrows denoting all parent-child relationships that cross the ridge
		b) added to the above, a line drawn down the middle of a valley, 
			with arrows crossing as before (OR, OUT OF A CIRCLE?)
        }
        \label{flux}
\end{figure}
