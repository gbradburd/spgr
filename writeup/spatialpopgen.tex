...
On the statistical side of the business,
common methods used to analyze these datasets --
...
Organisms live and move (at some life stage) in real, geographic space.
It is difficult to collect data and develop theory and methods
to capture this additional layer of complexity.
Sampling efforts are limited by time, money, and access.
Developing theory to describe evolutionary dynamics
without simplifying assumptions is,
by definition,
more difficult.
...
in some cases, methods for estimating the quantities we discuss do not exist, 
and in others, 
...
Rather than delving into the mechanics of specific methods,
