...
\g{The ability to generate large genomic datasets 
is facilitating the estimation of the timing of shared ancestry 
between individuals, 
which in turn allows the study of processes acting within specific windows of time, 
rather than averaged over the history of the sample.
\citep{Li_Durbin2011,Harris_Nielsen_2013,Palamara_2012}}
...
as spatial population genetic questions,
and to highlight ways that new datasets and 
...
Population size is often estimated using measures of genetic diversity such as $\pi$ \citep{NeiLi1979,Tajima89},
