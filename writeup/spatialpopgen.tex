...
if trace the path back up through the pedigree 
...
\plr{rather than ``instead we focus on'' shouldn't this transition be ``here's what we can actually learn about''?}
