...
\g{has not had as strong an effect on empirical work \citep[but see][]{landscape_genomics_review},
...
\citep{felsenstein1975pain,barton1995genealogies,barton-depaulis-etheridge, barton2010modelling, barton2010newmodel, hallatschek2011noisy, Barton2013},
...
\g{A more general model of dispersal would allow mean \emph{bias} in dispersal
(e.g., downwind, or up a fecundity gradient)
as well as spatial differences in dispersal variance.}
Furthermore, as implemented, ``resistance'' methods do not actually fit a mechanistic model of dispersal,
but rather make use of an approximation
that can result in estimates that differ widely from the truth,
especially in the presence of dispersal bias \citep{lundgren2018populations}.
...
even by 15 generations in the past,
...
\begin{figure}	%[H]
        \includegraphics[width=0.75\linewidth]{valley_ancestry_01.pdf}
        \includegraphics[width=0.75\linewidth]{valley_ancestry_60.pdf}
        \includegraphics[width=0.75\linewidth]{valley_ancestry_300.pdf}
        \caption{
...
For instance, genetic ancestors shared by the pink and purple individuals 
15 or 75 generations ago
are all found in the western valley.
\g{These shared ancestors can be informative about relative population densities in the two valleys.
...
\begin{figure}	%[H]
    \centering
        \includegraphics[width=0.85\linewidth]{valley_admixture_new}
        \includegraphics[width=0.85\linewidth]{valley_admixture_old}
        \caption{
...
\g{For example, if a beneficial allele arises once and goes to fixation in a hard selective sweep, 
the spatial pedigrees of all extant individuals will be forced,
going backward in time, 
to pass through the location of the individual in whom the sweeping mutation occurred.}
...
\g{Spatial population genetics suffers from a singular lack of concrete mathematical results
...
such as SLiM \citep{haller2018forward,haller2018treesequence} and msprime \citep{kelleher2016msprime}.
These methods allow
...
\g{approximate Bayesian computation \citep{MarjoramTavare2006modern}.
