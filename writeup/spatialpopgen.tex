...
These models were introduced to spatial population genetics by McRae (2006,2007,2008), 
...
One of the most promising current spatial methods is MAPS, 
...
MAPS builds on EEMS, an analogous method 
based on the resistance distance approximation, 
which replaces coalescence time with commute time.
MAPS & EEMS are a weird hybrid between continuous and discrete space.  
