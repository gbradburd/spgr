...
Note that we are distinguishing the ``resistance model'' of organism movement
...
especially if dispersal is biased \citep{lundgren2018populations}.}
...
these spread at constant speed rather than \g{diffusively} \citep{kelleher2016spread},
...
For example, after a ``hard'' selective sweep \g{sweep ref},
...
In all these situations, selection can produce dramatically different patterns in the \g{genealogies} 
...
Spatial population genetics is hindered by a lack of concrete mathematical results
that can be used for inference.
\g{Although Wright--Malec\'{o}t-like relations can be calculated numerically in heterogeneous geography,
our understanding of demographic noise in continuous space is still fuzzy.}
What can take the place of analytic formula?
