...
In addition, the location of an individual can be a complicated quantity to describe.
Individuals may move throughout a day, 
or through the seasons, 
and may reproduce several times at different locations, 
so that it is difficult to summarize the location of the individual 
with a single coordinate in space.
...
variation in space (more here than there),
...
For example, humans often have a substantial interest in estimating the locations of their ancestors
back in time.
More generally,
...
friendly reviewers: 
Ben Peter? Barton? JoNo? Andy K? Kelleher? Josh Schraiber? Is Petkova still in the game? 
Etheridge?
