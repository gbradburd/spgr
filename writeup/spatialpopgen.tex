...
e.g., empirical measurements of $F_{ST}$
...
\citep{barton-depaulis-etheridge, barton2010newmodel, Barton2013},
...
(for concreteness, taking their the location of their birth or germination,
...
may not reflect historical averages \cite{WhitlockMcCauley1999}.
However, 
...
the mean distance between the birth (germination/hatching/etcetera)
...
spatial identifiability problem 
need historical individuals to anchor the spatial pedigree
likewise, if density has changed lots and quickly
...
changing $\rho_e$ through time is maybe comparable to changing Ne.
	most likely to see it when there are few changes, 
	or when changes don't reverse themselves quickly.
