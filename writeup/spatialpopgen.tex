...
The focus of theory on results in discrete populations
both informed and was informed by early empirical datasets,
most of which
(although again,
with some exceptions \citep[e.g.,][]{Dobzhansky_Wright1943, dobzhansky1947},
...
connected by a vast pedigree 
anchored across time and space.
It has been much more difficult to collect data 
to capture this complexity.
Budgets, time, and technology have limited
the number of individuals that can be sampled 
and the number of loci that can be genotyped per individual, 
which in turn limits the capacity of researchers to 
place individuals in this pedigree.
Additionally, it is difficult to develop theory or methods 
in a worldview without discrete populations.
...
we would know everything about
...
\todo{reads like stream-of-consciousness.  needs roadmaps and reorganization.}
...
\g{this is the only place where we talk about estimation, 
so either add elsewhere, or cut.}
...
\todo{expand or drop - figure (and present-to-past approach) could be looped into dispersal section}
