...
We maintained stable local densities by increasing mortality in regions of high density,
...
A more general model of dispersal would allow mean \emph{bias} in dispersal
...
which can result in estimates that differ widely from the truth,
