...
%        \includegraphics[width=\linewidth]{figs/pedigree.pdf}
    ...
    \end{subfigure}
		...
		with an accompanying map of heterozygosity of individuals sampled across the two valleys, 
		illustrating the effect of population density on heterozygosity.}
		}
        \label{pop_density}
\end{figure}
