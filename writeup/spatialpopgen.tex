...
\todo{is this true in a non-panmictic population?}
...
%So, people refer to "population continuity," although I couldn't find an original ref for the idea.
%	seems like the opposite should be discontinuity?
% 	I guess it should actually be ``temporal discontinuity" rather than ``spatial discontinuity",
%	but the human literature calls it population continuity, so the non-discrete analogue seems like it should be ``spatial" something?
