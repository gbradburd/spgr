...
\begin{itemize}
%Alt intro -> new scope of datasets is allowing popgen to inform us about processes 
%acting on ecological timescales?
...
\g{I can't tell if this belongs in the introduction somehow.}
Before diving in, 
...
\g{peter, you were leery of using reverse-time, which I get, 
but I think it's helpful to consider the spatial history of a sample 
as another layer of stuff the coalescent is embedded in.
I.e., the coalescent is embedded in the pedigree, 
and the pedigree is embedded in the spatial history, 
so the set of gene genealogies in a sample can be informative 
about both the pedigree history and also the spatial history.}
