...
The scenarios simulated are not always realistic, 
but they do help build an intuition for the ideas they accompany.
>>>>>>> origin/master
...
to infer $\sigma$ using phylogenetic comparative methods 
\citep[although see also ][for a discussion of the limitations of these methods]{BartonWilson1995}.
>>>>>>> origin/master
