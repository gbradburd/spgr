...
\g{figure idea:} conceptual figure showing cartoonish differences in
tmrca times between pairs of individuals in a "high density" valley vs.
a low density valley
...
\plr{figure idea:} overlay malecot's formula on IBD plot

\plr{figure idea:} map for focal individual with points colored/sized according to closest degree of relatedness
...
\g{figure idea:} conceptual figure from 3.1 of tMRCA between
...
\subsubsection{Scenario: postglacial expansion and secondary contact}
        ...
        - How much does each individual inherit from each glacial refugium?
            ...
            \plr{figure idea:} pie charts of this quantity, at several times after secondary contact
