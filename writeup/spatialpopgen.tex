...
in genetic variation \citep{dobzhansky,human_blood_types,landscape_genomics_review}.
Most inference methods assume a small number of randomly mating populations,
...
giving us power to bring much more of population's pedigrees into focus.
...
and over short timescales that might have previously been out of reach for population genetics.
...
%Although the fundamental mathematical barriers to inference in continuous geography remain,
%computational advances now allow us to simulate models with spatial complexity,
%and therefore to both test the robustness of approximate methods
%and to use simulation directly for inference.
